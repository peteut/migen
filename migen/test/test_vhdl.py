...
@pytest.mark.parametrize(
    ...
    [((Constant(1), None, NameSpace(), None, None, None, _THint.integer, None),
     ...
     ((Constant(42), None, NameSpace(), None, None, None, _THint.logic,
       "foo'length"), "std_logic_vector(to_unsigned(42, foo'length))"),
     ((Constant(-42), None, NameSpace(), None, None, None, _THint.logic, 32),
...
@pytest.mark.parametrize(
    "args, expected",
    [((Cat(foo, bar), _Fragment(), NameSpace(), None, None, None, _THint.logic,
       None),
      "(bar & foo)"),
